...
(function (h) {
    ...
    function ob(a) {
        for (
            var b = a.oClasses, c = a.sTableId, d = a.aLengthMenu, e = h.isArray(d[0]), f = e ? d[0] : d, d = e ? d[1] : d, e = h("<select/>", { name: c + "", "aria-controls": c, class: b.sLengthSelect }), g = 0, j = f.length;
            g < j;
            g++
        )
            e[0][g] = new Option("number" === typeof d[g] ? a.fnFormatNumber(d[g]) : d[g], f[g]);
        var i = h("<div></div>").addClass(b.sLength);
        a.aanFeatures.l || (i[0].id = c + "");
    ...
    n.defaults = {
        ...
        oLanguage: {
            ...
            oPaginate: { sFirst: "First", sLast: "Last", sNext: "Après", sPrevious: "Avant" },
